...
```json
{
  "tiers": {
    "opus": {
      "model": "shiyun/claude-opus-4-8",
      "fallbackModels": ["shiyun-gpt/gpt-5.5"]
    },
    "sonnet": {
      "model": "shiyun/claude-sonnet-5",
      "fallbackModels": ["zai-glm/glm-5.2"]
    }
  },
  "agents": {
    "hyperresearch-fetcher": {
      "model": "zai-glm/glm-5.2",
      "fallbackModels": ["zai-glm/glm-5-turbo"]
    }
  }
}
```
