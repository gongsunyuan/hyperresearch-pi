...
- **light tier:** Skip directly to step 10 — invoke `load_skill(name: "hyperresearch-10-triple-draft")` (light tier writes a single draft, not the ensemble)
- **full tier:** Invoke `load_skill(name: "hyperresearch-3-contradiction-graph")`
